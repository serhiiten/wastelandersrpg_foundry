 ...
 */
export default class WastelandersSheetSettings extends FormApplication {
  /** @override */
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["wastelanders", "dialog", "sheet-settings"],
      width: "500",
      height: "fit-content",
    });
  }
  ...
  get template() {
    ...
    const sheetTemplate = `systems/wastelanders/templates/settings/${type}-settings.hbs`;
